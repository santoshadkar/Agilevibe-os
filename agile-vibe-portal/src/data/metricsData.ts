...
export const ENTERPRISE_ROLES: EnterpriseRoleInfo[] = [
  ...
  },
  {
    ...
    bgGradient: 'from-emerald-950/40 to-cyan-950/40',
...
export const GOVERNANCE_RITUALS: GovernanceRitual[] = [
  {
    cadence: 'Daily Standup / Daily Scrum',
    eventTitle: '15-Min Synchronous Flow Check-in',
    primaryRoles: ['Scrum Master', 'Technical Scrum Master', 'Squad / ART Developers', 'Product Owner'],
    metricsReviewed: ['KPI', 'KRI'],
    keyAgendaItems: [
      'Inspect Sprint Burndown & Flow Blockers',
      'Check build/pipeline status & defect spike KRIs',
      'Identify immediate dependencies needing escalation'
    ],
    outputsAndArtifacts: 'Updated Sprint Kanban board, immediate impediment log entry, cleared build blocker'
  },
  {
    cadence: 'Sprint Iteration Review & Retrospective',
    eventTitle: 'End-of-Sprint Adapt & Learn Session',
    primaryRoles: ['Scrum Master', 'Product Owner', 'TSM', 'Squad Members'],
    metricsReviewed: ['KPI', 'OKR'],
    keyAgendaItems: [
      'Evaluate Sprint Velocity & Flow Efficiency KPIs',
      'Review Key Result progress against Sprint Goal',
      'Analyze escapable defect rate and action item completion'
    ],
    outputsAndArtifacts: 'Retro Action Items backlog, validated velocity trend, updated Definition of Done'
  },
  {
    cadence: 'PI Planning / System Demo (Monthly/PI)',
    eventTitle: 'Big Room / Scaled Alignment Event',
    primaryRoles: ['Release Train Engineer (RTE)', 'Agile Transformation Leader', 'Product Manager', 'AI Leader'],
    metricsReviewed: ['OKR', 'KRI', 'KRA'],
    keyAgendaItems: [
      'Measure ART PI Predictability Measure (Target: 80%-100%)',
      'Assess cross-team dependency risk KRIs',
      'Align upcoming PI Objectives with Strategic Theme OKRs'
    ],
    outputsAndArtifacts: 'Committed PI Objectives, Program Board with cross-ART dependencies, Risk ROAMing log'
  },
  {
    cadence: 'Quarterly Business Review (QBR)',
    eventTitle: 'Executive Strategic Alignment & Resourcing',
    primaryRoles: ['AI Leader', 'Agile Transformation Leader', 'Product Manager', 'Enterprise Coach'],
    metricsReviewed: ['OKR', 'KRA', 'KRI'],
    keyAgendaItems: [
      'Grade QBR Strategic OKRs (Target score 0.6 - 0.7 for stretch targets)',
      'Review Enterprise AI Adoption & Flow Efficiency KRAs',
      'Adjust budget allocations based on Market Value & ROI KPIs'
    ],
    outputsAndArtifacts: 'Scored Strategic OKR Deck, revised Value Stream funding, updated Enterprise Risk Matrix'
  }
];
