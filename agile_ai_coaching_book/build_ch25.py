...
os.makedirs(PART8_DIR, exist_ok=True)

# ----------------------------------------------------
# CHAPTER 25: Local SLMs & On-Premise AI Architecture
# ----------------------------------------------------
ch25_content = """# Chapter 25: Local SLMs & On-Premise AI Architecture for Agile Enterprises
...
with open(os.path.join(PART8_DIR, "ch25_local_slms_ollama.md"), "w", encoding="utf-8") as f:
    f.write(ch25_content)

print("Created Chapter 25 markdown.")
