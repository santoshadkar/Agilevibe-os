...
def save_ch(path, title, tagline, sections):
    ...
    out = [f"# {title}\n\n> *\"{tagline}\"*\n\n---\n\n"]
    for idx, (sec_name, blocks) in enumerate(sections, 1):
...
def run_part1():
    ...
    save_ch("chapters/part1_coaching/ch01_modern_agile_spectrum.md", "Chapter 1: The Modern Enterprise Agile Spectrum", "Scrum, Kanban, SAFe 6.0, LeSS, Spotify & Organizational Descaling", [ch01_s1, ch01_s2, ch01_s3, ch01_s4, ch01_s5])
