...
ch26_content = """# Chapter 26: Building Multi-Agent Coaching Systems with LangChain & LangGraph
...
with open(os.path.join(PART8_DIR, "ch26_langchain_langgraph_agents.md"), "w", encoding="utf-8") as f:
    f.write(ch26_content)

print("Created Chapter 26 markdown.")
