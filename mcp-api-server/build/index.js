 ...
 */
server.tool("fetch_rest_api", "Fetch data from any public REST API endpoint via GET request", {
 ...
 */
server.tool("post_rest_api", "Send POST JSON payload to a REST API endpoint", {
 ...
 */
server.tool("get_weather_forecast", "Get real-time weather forecast for latitude and longitude coordinates using Open-Meteo API", {
    latitude: z
        .number()
 ...
 */
server.tool("get_mock_posts", "Retrieve sample posts from JSONPlaceholder mock API service", {
    limit: z
        .number()
        .min(1)
        .max(20)
